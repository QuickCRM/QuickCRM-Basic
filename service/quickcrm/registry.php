...
class registry_quickcrm extends registry_v4_1 {
	...
	protected function registerFunction()
	{
	   ...
	   $this->serviceClass->registerFunction(
		    'get_computation',
		    array('session'=>'xsd:string', 'module_name'=>'xsd:string', 'query'=>'xsd:string', 'select_fields'=>'xsd:select_fields','operators'=>'xsd:select_fields'),
		    array('return'=>'tns:entry_list'));
